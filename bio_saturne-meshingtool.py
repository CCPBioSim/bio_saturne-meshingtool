...
def main():
    ...
    print("------------------------------------------------------------------")
    print("All files generated by bio_saturne-meshingtool for this run can be\n"
          "found in "+ run_directory)
    print("------------------------------------------------------------------")
    ...
    print("Further files generated by intercalated software are stored in "
          +run_directory+"/.tmp")
    exit_tool()
