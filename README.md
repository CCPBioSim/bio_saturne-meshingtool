...
is created. This contains histogram pdf files which are generated from the data in the quality log. They describe various aspects of the mesh, as listed below.
