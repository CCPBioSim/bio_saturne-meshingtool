...
```
The **loggers directory** will contain the logging files generated by the meshing software and code_saturne. The **quality directory** will contain the file generated by code_saturne which contains information about the mesh and data related to its quality. 
